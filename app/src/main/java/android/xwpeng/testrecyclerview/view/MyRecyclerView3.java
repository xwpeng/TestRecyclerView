...
public class MyRecyclerView3 extends BasicRecyclerView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (hasChildOpen()) {
                ...
                if (touchView != null && touchView instanceof SwipeMenuLayout3 && ((SwipeMenuLayout3) touchView).isOpen()) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (touchView != null && touchView instanceof SwipeMenuLayout3) {
                    SwipeMenuLayout3 swipeItem = (SwipeMenuLayout3) this.touchView;
    ...
    private boolean hasChildOpen() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            ...
            if (child != null && child instanceof SwipeMenuLayout3) {
                if (((SwipeMenuLayout3) child).isOpen()) {
                    return true;
                }
            }
        }
