 ...
 */
public class SwipeMenuLayout5 extends ViewGroup {
    ...
    //存储的是当前正在展开的View
    private static SwipeMenuLayout5 mViewCache;
    ...
    public SwipeMenuLayout5(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SwipeMenuLayout5(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public static SwipeMenuLayout5 getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeMenuLayout5.this;
