...
public class MyRecyclerView2 extends BasicRecyclerView {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN) {
            ...
            if (hasChildOpen()) {
                ...
                if (touchView != null && touchView instanceof SwipeMenuLayout2 && ((SwipeMenuLayout2) touchView).isOpen()) {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (touchView != null && touchView instanceof SwipeMenuLayout2) {
                    SwipeMenuLayout2 swipeItem = (SwipeMenuLayout2) this.touchView;
    ...
    private boolean hasChildOpen() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            ...
            if (child != null && child instanceof SwipeMenuLayout2) {
                if (((SwipeMenuLayout2) child).isOpen()) {
                    return true;
                }
            }
        }
